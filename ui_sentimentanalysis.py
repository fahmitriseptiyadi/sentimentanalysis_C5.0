...
"")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/asset/images/dataset_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/asset/images/dataset_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.dataset_2.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/asset/images/nlp_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon3.addFile(u":/asset/images/nlp_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.pre_2.setIcon(icon3)
...
"}")
        ...
        self.wordcloud_label_2 = QLabel(self.preprocessing_page)
        self.wordcloud_label_2.setObjectName(u"wordcloud_label_2")
        self.wordcloud_label_2.setGeometry(QRect(550, 640, 371, 231))
        self.wordcloud_label_2.setScaledContents(True)
        ...
        self.label_7.setGeometry(QRect(360, 300, 291, 41))
...
"or drop csv. here", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Pre Batch-1", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Pre Batch-2", None))
#if QT_CONFIG(tooltip)
        ...
        self.wordcloud_label_2.setText("")
